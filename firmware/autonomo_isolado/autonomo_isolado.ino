...
void entrar(Fase nova, unsigned long agora) {
  ...
  switch (fase) {
    ...
    case CURVA:
      if (direita) motores(LOW, HIGH, HIGH, LOW, "DIREITA");
      else motores(HIGH, LOW, LOW, HIGH, "ESQUERDA");
      break;
...
void status() {
  Serial.print(F("AUTO|UP:")); Serial.print(millis());
