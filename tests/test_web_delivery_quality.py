...
class TestWebDeliveryQuality(unittest.TestCase):
    ...
    def test_asset_versions_force_the_professional_release(self) -> None:
        for marker in ("web/styles.css?v=22", "web/app.js?v=19", "web/code-editor-utils.js?v=1", "web/face-identity-math.js?v=2", "web/face-identities.js?v=15", "web/person-follow.js?v=1"):
