...
class TestWebDeliveryQuality(unittest.TestCase):
    ...
    def test_asset_versions_force_the_professional_release(self) -> None:
        for marker in ("web/styles.css?v=22", "web/app.js?v=21", "web/robot-control.js?v=25", "web/arduino-codes.js?v=20", "web/arduino-flasher.js?v=14", "web/simulator-world.js?v=7",
